...
import pip
from Insurance.utils import read_yaml_file, write_yaml_file
...
MODEL_CONFIG_FILE_PATH = os.path.join(ROOT_DIR, MODEL_FILE_PATH)
...
INSURANCE_EXP_VALUE_KEY = "expenses"
