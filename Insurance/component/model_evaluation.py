...
import os
import sys
from Insurance.utils import write_yaml_file, read_yaml, load_object,load_data,read_yaml_file
...
class ModelEvaluation:
    ...
    def get_best_model(self):
        try:
            model = None
            model_evaluation_file_path = str(self.model_evaluation_config.model_evaluation_file_path)
    ...
    def update_evaluation_report(self, model_evaluation_artifact: ModelEvaluationArtifact):
        try:
            eval_file_path = str(self.model_evaluation_config.model_evaluation_file_path)
